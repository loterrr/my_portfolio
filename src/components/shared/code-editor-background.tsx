  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        className="absolute bottom-0 right-0 top-0 w-16 hidden xl:block pointer-events-auto cursor-pointer group border-l border-border/20"
      >
        <div 
        ...
        <div 
          className="absolute right-0 w-16 bg-code-keyword/20 border-y border-code-keyword/30 transition-all duration-75"
          style={{ 
            height: "15%", 
        ...
        <div className="absolute top-4 right-1 bottom-4 w-14 flex flex-col gap-1 overflow-hidden opacity-30 group-hover:opacity-50 transition-opacity">
